...
#[derive(Debug, Clone)]
#[allow(dead_code)] // Public API for resource monitoring
...
#[derive(Debug, Clone)]
#[allow(dead_code)] // Public API for disk information
pub struct DiskInfo {
    pub name: String,
...
impl ResourceMonitor {
    ...
    pub fn get_stats(&mut self) -> ResourceStats {
        ...
        let cpu_usage = cpus.iter().map(sysinfo::Cpu::cpu_usage).sum::<f32>() / cpu_count as f32;
